...
{
	// Determines the movement of the enemies
	...
	// makes it so that the enemies move in the direction they are facing
	...
	asteroidVelocity += spriteVelocityAdd;

	spritePos2D += asteroidVelocity * deltaTime;

	asteroidVelocity *= 0.95;
}
/*
=================================================================
